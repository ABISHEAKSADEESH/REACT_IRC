      ...
      >
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            ...
            >
              <Box onClick={()=>{setOffer('ff10');onClose()}}
                style={{
                  display: 'flex',
              ...
              <Box
              onClick={()=>{setOffer('f2f08');onClose()}}
                style={{
                  display: 'flex',
                  flexDirection: 'column',
                  gap: '5px',
              ...
              <Box
              onClick={()=>{setOffer('f3f06');onClose()}}
                style={{
                  display: 'flex',
                  flexDirection: 'column',
                  gap: '5px',
              ...
              <Box
              onClick={()=>{setOffer('freecff');onClose()}}
                style={{
                  display: 'flex',
                  flexDirection: 'column',
                  gap: '5px',
              ...
              <Box
              onClick={()=>{setOffer('getfrfd');onClose()}}
                style={{
                  display: 'flex',
                  flexDirection: 'column',
                  gap: '5px',
